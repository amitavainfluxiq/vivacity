<div class="row acuityblock7wrapper">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 acuityblock7">
  <!--      <ul class="list-inline ftsocialmedia">
            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#mysocialModal"><img src="system/themes/acuity_landing/images/acl_sm_img1.png"></a></li>
            <li><a href="javascript:void(0)"  data-toggle="modal" data-target="#mysocialModal"><img src="system/themes/acuity_landing/images/acl_sm_img2.png"></a></li>
            <li><a href="javascript:void(0)"  data-toggle="modal" data-target="#mysocialModal"><img src="system/themes/acuity_landing/images/acl_sm_img3.png"></a></li>
            <li><a href="javascript:void(0)"  data-toggle="modal" data-target="#mysocialModal"><img src="system/themes/acuity_landing/images/acl_sm_img4.png"></a></li>
            <li><a href="javascript:void(0)"  data-toggle="modal" data-target="#mysocialModal"><img src="system/themes/acuity_landing/images/acl_sm_img5.png"></a></li>
            <li><a href="javascript:void(0)"><img src="system/themes/acuity_landing/images/acl_sm_img6.png"></a></li>
        </ul>
-->
        <ul class="list-inline ftcopyright">


            <li> <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalPolicyprocedures">Policies and Procedures</a></li>
            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#myModalterms">Terms of Use</a></li>
            <li> <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalrefundandreturns">Refund and Returns</a></li>
            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#myModalPrivacyPolicy">Privacy Policy</a> </li>



            <li><span>© Copyright 2016 Vivacity - All Rights Reserved</span></li>
        </ul>
...
<div class="modal fade socialmodal" id="mysocialModal" role="dialog">
