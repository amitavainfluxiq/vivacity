...
$product_html = '<tr> 
                ...
                <th style="background:#51b517; font-size:14px; color:#fff; font-weight:normal;" width="5%" valign="middle" align="center"><img src="system/themes/prelaunch_lp/images/arrowimgupdate.png" alt="#"></th>
                <th class="thrightmain" style="background:#51b517; font-size:14px; color:#fff; font-weight:normal    text-align:right; " width="16%" valign="middle" align="right"><span class="thright" >Total </span></th>
                <th style="background:#51b517;" width="2%" valign="middle" align="left">&nbsp;</th>
            </tr>';
    ...
    <div class="success_table_block">
        ...
        <div class="success_table_block_con">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    <td align="left" valign="middle" style="background:#025285;">&nbsp;</td>


                    <td  colspan="5" style="color:#fff; background:#025285; text-align: right;" valign="middle" align="right"><div class="td_text td_text1">Grand Total</div></td>
                    <td   style="background:#025285;" valign="middle" align="left">&nbsp;</td>
                    <td   style="color:#fff; background:#025285; text-align: right; padding-right: 20px!important;" valign="middle" align="right"><div class="td_valu">$<?php echo $total_amnt;?></div></td>
                    <td   align="left" valign="middle" style="background:#025285;">&nbsp;</td>
