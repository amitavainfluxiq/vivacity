...
$userId = $AI->user->userID;
$emailid = $AI->user->email;
db_query("update users set account_type='Distributor' where userID=".$userId);
...
if($accept_term == 0) {
    ...
    <div class="dl_content_block">
        ...
        <form action="" method="post" onsubmit="return validate()">
            ...
            <input type="hidden" name="bill_first_name" value="<?php echo @$bp_addr['first_name'];?>">
            <input type="hidden" name="bill_last_name" value="<?php echo @$bp_addr['last_name'];?>">
            <input type="hidden" name="bill_address_line_1" value="<?php echo @$bp_addr['address_line_1'];?>">
            <input type="hidden" name="bill_city" value="<?php echo @$bp_addr['city'];?>">
            <input type="hidden" name="bill_region" value="<?php echo @$bp_addr['region'];?>">
            <input type="hidden" name="bill_country" value="<?php echo @$bp_addr['country'];?>">
            <input type="hidden" name="bill_postal_code" value="<?php echo @$bp_addr['postal_code'];?>">
            <input type="hidden" name="email" value="<?php echo @$bp_addr['email'];?>">
            <input type="hidden" name="ship_first_name" value="<?php echo @$bp_shipaddr['first_name'];?>">
            <input type="hidden" name="ship_last_name" value="<?php echo @$bp_shipaddr['last_name'];?>">
            <input type="hidden" name="ship_address_line_1" value="<?php echo @$bp_shipaddr['address_line_1'];?>">
            <input type="hidden" name="ship_city" value="<?php echo @$bp_shipaddr['city'];?>">
            <input type="hidden" name="ship_region" value="<?php echo @$bp_shipaddr['region'];?>">
            <input type="hidden" name="ship_country" value="<?php echo @$bp_shipaddr['country'];?>">
            <input type="hidden" name="ship_postal_code" value="<?php echo @$bp_shipaddr['postal_code'];?>">
            <div>
