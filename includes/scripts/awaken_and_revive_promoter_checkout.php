...
function after_saveorder($userid,$util_rep_id,$orderid){
    ...
    util_redirect('promoter-success?order='.$orderid);
...
<div class=" col-lg-8 col-md-8 col-sm-12 col-xs-12 vcproduct_block">
    ...
    <div class="vcproduct_block_newwrapper">
      ...
      <!--  <div class="vcproduct_block_table vcproductactiveblock">
            <table width="100%" border="0">
                <tr>
                    <th colspan="2">Buy 1</th>
                </tr>

                <tr>
                    <td align="center" valign="middle" class="balance_pro_img"> <img class="img-responsive" src="system/themes/awaken_and_revive/images/balance_pro1.png"></td>
                    <td align="center" valign="middle" class="balance_pro_text">
                        <h2>Buy 1</h2>
                        <h3> $62.45</h3>
        ...
        <div class="vcproduct_block_table">
            <table width="100%" border="0">
                <tr>
                    <th colspan="2">Buy 2 get 1 free </th>
                </tr>

                <tr>
                    <td align="center" valign="middle" class="balance_pro_img"> <img class="img-responsive" src="system/themes/awaken_and_revive/images/balance_pro2.png"></td>
                    <td align="center" valign="middle" class="balance_pro_text">
        ...
        <div class="vcproduct_block_table">
            <table width="100%" border="0">
                <tr>
                    <th colspan="2">Buy 3 Get 2 Free  </th>
                </tr>

                <tr>
                    <td align="center" valign="middle" class="balance_pro_img"> <img class="img-responsive" src="system/themes/awaken_and_revive/images/balance_pro3.png"></td>
                    <td align="center" valign="middle" class="balance_pro_text">
