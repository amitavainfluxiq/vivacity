...
$landing_page = new C_landing_pages('vitality-landing');
  ...
  //  echo $orderid;exit;
    ...
    if(intval($orderid) > 0){
       /* $o_res = db_query("SELECT `o`.`userID`,`o`.`date_added`,`o`.`billing_addr`,`o`.`shipping_addr`,`o`.`shipping`,`o`.`tax`,`o`.`total`,`od`.* FROM `orders` `o` INNER JOIN `order_details` `od` ON `o`.`order_id` = `od`.`order_id` WHERE `o`.`order_id` = ".$orderid);*/
        ...
        $o_res = db_query("SELECT `o`.`userID`,`o`.`date_added`,`o`.`billing_addr`,`o`.`shipping_addr`,`o`.`shipping`,`o`.`tax`,`o`.`total`,`od`.*,`psi`.`product_code` FROM `orders` `o` INNER JOIN `order_details` `od` ON `o`.`order_id` = `od`.`order_id` INNER JOIN `product_stock_items` `psi`  ON `od`.`stock_item_id`=`psi`.`stock_item_id` WHERE `o`.`order_id` = ".$orderid);
       ...
       // exit;
        ...
        $email_name = 'Vitality Order Success';
        ...
        $vars['pname'] = $order['title'].' '.$order['product_code'];
    ...
    util_redirect('vitalitysuccess?order='.$orderid);
...
$product3=array();
$product4=array();
$p_res = db_query("SELECT `ps`.`product_id`,`ps`.`stock_item_id`,`ps`.`price`,`p`.`title`,`p`.`img_url`,`ps`.`product_code` FROM `product_stock_items` `ps` RIGHT JOIN `products` `p` ON `p`.`product_id` =`ps`.`product_id` ");
while($p_res && $product = db_fetch_assoc($p_res)) {
    $price_arr[] = $product['price'];
    if ($product['stock_item_id'] == 38) {
        $product1=$product;
    }
    if ($product['stock_item_id'] == 44) {
        $product2=$product;
    }
    if ($product['stock_item_id'] == 45) {
        $product3=$product;
    }if ($product['stock_item_id'] == 46) {
        $product4=$product;
    }
}
...
<div class="container-fluid toplogoblock text-center">
    <img class="img-responsive" src="system/themes/vibrancy_landing/images/landing1_logo.png">
</div>
    ...
    <div class=" col-lg-8 col-md-8 col-sm-12 col-xs-12 vcproduct_block">
        ...
        <div class="vcproduct_block_top">
            <div class="vcproduct_block_top_wrapper">
                <img class="new_pro_mcafee" src="system/themes/vibrancy_landing/images/new_pro_mcafee.png">
                <div class="new_pro_top_bannertext">
                    <h1>vitality</h1>
                </div>
                <img class="new_pro_top_bannertext2" src="system/themes/vibrancy_landing/images/new_pro_top_bannertext2.png">
            </div>
        </div>
        ...
        <div class="vcproduct_block_newwrapper">
            ...
            <?php if(count($product4)>0){
                ...
                <div class="vcproduct_block_table">
                    <table width="100%" border="0">
                        <tr>
                            <th colspan="2"><?php echo $product4['product_code'] ?></th>
                        </tr>

                        <tr>
                            <td align="center" valign="middle" class="balance_pro_img"> <!--<img class="img-responsive" src="<?php /*echo $product4['img_url'] */?>">--><img class="img-responsive" src="system/themes/vibrancy_landing/images/vibrancy4.png">
                            ...
                            <td align="center" valign="middle" class="balance_pro_text">
                                ...
                                <h6>Per Program! </h6>
                                <input class="pselbtn" id="pbtn<?php echo $product4['stock_item_id'] ?>" type="button" value="Select" ptitle="<?php echo $product4['title'] ?>" pcode="<?php echo $product4['product_code'] ?>" pprice="<?php echo $product4['price'] ?>" stock_item_id="<?php echo $product4['stock_item_id'] ?>">
                            </td>
                        </tr>
                    </table>
            ...
            <?php if(count($product3)>0){
                ...
                <div class="vcproduct_block_table">
                    <table width="100%" border="0">
                        <tr>
                            <th colspan="2"><?php echo $product3['product_code'] ?> </th>
                        </tr>

                        <tr>
                            <td align="center" valign="middle" class="balance_pro_img"> <!--<img class="img-responsive" src="<?php /*echo $product3['img_url'] */?>">--> <img class="img-responsive" src="system/themes/vibrancy_landing/images/vibrancy3.png"></td>
                            <td align="center" valign="middle" class="balance_pro_text">
                                ...
                                <h6>Per Program! </h6>
                                <input class="pselbtn" id="pbtn<?php echo $product3['stock_item_id'] ?>" type="button" value="Select" ptitle="<?php echo $product3['title'] ?>" pcode="<?php echo $product3['product_code'] ?>" pprice="<?php echo $product3['price'] ?>" stock_item_id="<?php echo $product3['stock_item_id'] ?>">
                            </td>
                        </tr>
                    </table>
            ...
            <?php if(count($product2)>0){
                ...
                <div class="vcproduct_block_table">
                    <table width="100%" border="0">
                        <tr>
                            <th colspan="2"><?php echo $product2['product_code'] ?></th>
                        </tr>

                        <tr>
                            <td align="center" valign="middle" class="balance_pro_img"> <!--<img class="img-responsive" src="<?php /*echo $product2['img_url'] */?>">--><img class="img-responsive" src="system/themes/vibrancy_landing/images/vibrancy2.png"></td>
                            <td align="center" valign="middle" class="balance_pro_text">
                                ...
                                <h6>Per Program! </h6>
                                <input class="pselbtn" id="pbtn<?php echo $product2['stock_item_id'] ?>" type="button" value="Select" ptitle="<?php echo $product2['title'] ?>" pcode="<?php echo $product2['product_code'] ?>" pprice="<?php echo $product2['price'] ?>" stock_item_id="<?php echo $product2['stock_item_id'] ?>">
                            </td>
                        </tr>
                    </table>
            ...
            <?php if(count($product1)>0){
                ...
                <div class="vcproduct_block_table">
                    <table width="100%" border="0">
                        <tr>
                            <th colspan="2"><?php echo $product1['product_code'] ?></th>
                        </tr>

                        <tr>
                            <td align="center" valign="middle" class="balance_pro_img"> <!--<img class="img-responsive" src="<?php /*echo $product1['img_url'] */?>">--> <img class="img-responsive" src="system/themes/vibrancy_landing/images/vibrancy1.png">
                            ...
                            <td align="center" valign="middle" class="balance_pro_text">
                                ...
                                <input class="pselbtn" id="pbtn<?php echo $product1['stock_item_id'] ?>" type="button" value="Select" ptitle="<?php echo $product1['title'] ?>" pcode="<?php echo $product1['product_code'] ?>" pprice="<?php echo $product1['price'] ?>" stock_item_id="<?php echo $product1['stock_item_id'] ?>">
    ...
    <div class=" col-lg-4 col-md-4 col-sm-12 col-xs-12 vcform_block2">
        ...
        <div class="productformnew">
            <div class="formheadingnew">
                ...
                <img class="img-responsive" src="system/themes/vibrancy_landing/images/affiliate-checkout_lockicon.png" style="display: block; margin: 0 auto;">
                <h1>FINAL STEP</h1>
                ...
                <div class="new_form_divwrapper">
                    ...
                    <div class="new_form_blockcon2">
                        ...
                        <div class="form-group">
                            ...
                            <img class="img-responsive" src="system/themes/vibrancy_landing/images/affiliate-checkout_cardicon.jpg">
                            <div class="clearfix"></div>
                        </div>
    ...
    <div class="vcproduct_orderbox awakentavlevlock" id="revive-promoter-checkout">
        <table width="100%" border="0">
            ...
            <tr>
                ...
                <td valign="middle" align="left"><span id="product_code">No Package</span></td>
            </tr>
            <tr>
