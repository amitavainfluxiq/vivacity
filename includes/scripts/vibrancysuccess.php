...
$product_html = '<tr> 
                ...
                <th style="background:#e7024d;" width="2%" valign="middle" align="left">&nbsp;</th>
                <th style="background:#e7024d; font-size:14px; color:#fff; font-weight:normal; text-align: left; " width="47%" valign="middle" align="left">Item Description</th>
                <th style="background:#e7024d; font-size:14px; color:#fff; font-weight:normal; " width="5%" valign="middle" align="center"><img src="system/themes/prelaunch_lp/images/arrowimgupdate.png" alt="#"></th>
                <th style="background:#e7024d; font-size:14px; color:#fff; font-weight:normal; text-align: right; " width="9%" valign="middle" align="right"> Price</th>
                <th style="background:#e7024d; font-size:14px; color:#fff; font-weight:normal; " width="5%" valign="middle" align="center"><img src="system/themes/prelaunch_lp/images/arrowimgupdate.png" alt="#"></th>
                <th style="background:#e7024d; font-size:14px; color:#fff; font-weight:normal; text-align:right; " width="8%" valign="middle" align="right">Qty. </th>
                <th style="background:#e7024d; font-size:14px; color:#fff; font-weight:normal;" width="5%" valign="middle" align="center"><img src="system/themes/prelaunch_lp/images/arrowimgupdate.png" alt="#"></th>
                <th class="thrightmain" style="background:#e7024d; font-size:14px; color:#fff; font-weight:normal    text-align:right; " width="16%" valign="middle" align="right"><span class="thright" >Total </span></th>
    ...
    <div class="success_table_block">
        ...
        <div class="success_table_block_con">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    <td align="left" valign="middle" style="background:#3f3c41 ;">&nbsp;</td>


                    <td  colspan="5" style="color:#fff; background:#3f3c41 ; text-align: right;" valign="middle" align="right"><div class="td_text td_text1">Grand Total</div></td>
                    <td   style="background:#3f3c41 ;" valign="middle" align="left">&nbsp;</td>
                    <td   style="color:#fff; background:#3f3c41 ; text-align: right; padding-right: 20px!important;" valign="middle" align="right"><div class="td_valu">$<?php echo $total_amnt;?></div></td>
                    <td   align="left" valign="middle" style="background:#3f3c41 ;">&nbsp;</td>
