...
<div class="footer_menu_wrapper">
   <!-- <a href="javascript:void(0)"> Privacy Policy</a> | <a href="javascript:void(0)"> Terms & Conditions</a> | <a href="javascript:void(0)">  Privacy Policy</a> | <a href="javascript:void(0)">  Product Data Sheet</a>-->
    <a href="javascript:void(0)" onclick="opena()">Policies and Procedures</a> | <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalterms">Terms of Use</a> | <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalrefundandreturns">Refund and Returns</a> | <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalPrivacyPolicy">Privacy Policy</a> | <a href="login?ai_bypass=true">Login</a>
</div>
    <h3>&copy; Copyright &copy; 2017 Vivacity - All Rights Reserved </h3>

    <h4>Lorem ipsum dolor sit amet, dolorum commune ut sea. Vim persius gloriatur an. Nec habemus appareat ne. Id duo tollit evertitur, te dico vivendo est. Ea sit ponderum singulis, in impedit maiestatis sit. Sumo soluta ne vim.
        <br/> <br/>
        Sit id dicta cetero principes, ei diam deseruisse cum, qui ad noster gubergren adolescens. Mutat solum persecuti vel et, et has homero deleniti. Ad ius hinc pertinacia. <span>Vix doming accusam</span> adolescens ne, ad malis ridens rationibus nam, sed ei lorem velit augue. <span>Quo</span> ne dicam ceteros explicari, eam cu detraxit posidonium reprehendunt, te mea posse copiosae assueverit. Dicam aperiri maluisset ei pri.
    </h4>
...
<style>
.footermodel .modal-header{background: #397714; width: 100%; margin: 0; padding: 0; min-height: 73px;border-radius-topleft:6px;
border-radius-topright:6px; -webkit-border-radius-topleft:6px; -webkit-border-radius-topright:6px; -moz-border-radius-topleft:6px;    -moz-border-radius-topright:6px;}
.footermodel .modal-header h4.modal-title {
margin-top: 0px;
margin-bottom: 0px;
...
.footermodel .modal-header .close{background: #323232 !important; opacity: 1; color: #fff; padding: 5px 9px; border-radius: 100%;margin-top: -7px; margin-right: -10px;}
...
font-weight: normal; background: url("../images/popupicon.png") no-repeat left 8px; padding: 0 0 10px 15px;
}


.footermodel .modal-dialog{ width:80%; color: #333;}

.footermodel .modal-body{ padding: 35px;}
.footermodel h2{ color: #387414; font-size: 24px;}
.footermodel b strong{ color: #387414; font-size: 24px;}

.footermodel label{ color: #387414; }

.footermodel a{ color: #333; text-decoration: underline; cursor: pointer; }

.footermodel a:hover{ color: #387414; text-decoration: none; }

.classdiv1_new{ margin: 0 0 15px 0;}

.classdiv1{ margin: 0 0 15px 0;}

.classdiv2{ margin: 0 0 15px 0px;}


.btnjoinnow{ cursor: pointer;}


.close{ box-shadow:none!important; outline: none;}
</style>