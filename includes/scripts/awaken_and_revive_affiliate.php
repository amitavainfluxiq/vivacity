...
if(!isset($_SESSION['awaken-and-revive-affiliate']['form_data'])){
...
$landing_page->next_step = 'awaken-and-revive-affiliate-checkout';
...
<div class="container-fluid topleftbg topleftbg2">

    <div class="container-fluid toprightbg">

        <div class="container AFF_topblock AFF_topblock2">
            ...
            <div class="row">
                <div class="top_leftpart">
                    ...
                    <img src="system/themes/awaken_and_revive/images/affiliate_top_img1.png" class="affiliate_top_img1">
...
<div class="container-fluid aff_block2">
    ...
    <div class="container affblock2wrapper">
        ...
        <img src="system/themes/awaken_and_revive/images/affiliate_bloc2img.png" class="affiliate_bloc2img">
        ...
        <div class="block2_textcon">
            ...
            <h5>What it takes to lose weight</h5>
...
<div class="container-fluid aff_block3">
    ...
    <div class="container affblock3wrapper">
        ...
        <img src="system/themes/awaken_and_revive/images/affiliate_bloc3img.png" class="affiliate_bloc3img">
        ...
        <a href="javascript:void(0)" class="block3btn getmybottle">GET THE 24-HOUR CORE DYNAMICS<br/>
            SYSTEM RIGHT AWAY!</a>
...
<div class="container-fluid aff_block5">
    ...
    <div class="container affblock5wrapper">
        ...
        <div class=" affblock5main_wrapper affblock5main_wrapper1">
            ...
            <a href="javascript:void(0)" class="block5btn getmybottle">GET THE 24-HOUR CORE DYNAMICS<br/>
                SYSTEM RIGHT AWAY!</a>
        </div>
    </div>
</div>
...
<div class="container-fluid aff_block8">
    ...
    <div class="container affblock8wrapper">
        ...
        <div class="block8_textwrapper">
            ...
            <img src="system/themes/awaken_and_revive/images/block8_img1.png" class="block8_img1affiliate">
            <img src="system/themes/awaken_and_revive/images/block8_img4.png" class="block8_img4">


            <img src="system/themes/awaken_and_revive/images/affiliate_bloc4img.png" class="affiliate_bloc4img">
            <img src="system/themes/awaken_and_revive/images/block8_movileview.png" class="block8_movileview">

            <a href="javascript:void(0)" class="block8btn getmybottle">RUSH MY ORDER TODAY!</a>
        </div>
...
<div class="container-fluid aff_block9">
    ...
    <div class="container affblock9wrapper">
        ...
        <img src="system/themes/awaken_and_revive/images/affiliate_bloc5img.png" class="block9_img4">
